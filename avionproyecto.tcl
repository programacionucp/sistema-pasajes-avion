...
#  Apr 18, 2020 08:12:23 PM -03  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top43 {base} {
    ...
    frame $site_3_0.fra46 \
        ...
        -height 420 -width 253 
    vTcl:DefineAlias "$site_3_0.fra46" "Frame1" vTcl:WidgetProc "Toplevel1" 1
    set site_4_0 $site_3_0.fra46
    label $site_4_0.lab47 \
        -background #ff8040 -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) -text {registro de pasajeros:} 
    ...
    label $site_4_0.lab49 \
        ...
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) -text Nombre: 
    vTcl:DefineAlias "$site_4_0.lab49" "Label2" vTcl:WidgetProc "Toplevel1" 1
    entry $site_4_0.ent50 \
        -background white -disabledforeground #a3a3a3 -font TkFixedFont \
        -foreground $vTcl(actual_gui_fg) -insertbackground black -width 10 
    vTcl:DefineAlias "$site_4_0.ent50" "Entry2" vTcl:WidgetProc "Toplevel1" 1
    label $site_4_0.lab51 \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) -text Cedula: 
    ...
    label $site_4_0.lab54 \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) -text Clase: 
    ...
    place $site_4_0.lab49 \
        -in $site_4_0 -x 0 -relx 0.356 -y 0 -rely 0.167 -width 0 \
        -relwidth 0.245 -height 0 -relheight 0.09 -anchor nw \
        -bordermode ignore 
