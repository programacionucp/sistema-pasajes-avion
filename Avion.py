...
def Requerimientos():
    ...
    def Registrar_Pasajero():
        ...
        lbl_Nombre= Label(root, text='Nombre:',bg='purple',fg='yellow').pack()
        Nombre = StringVar()
        Entry_Nombre = Entry(root, textvariable=Nombre)
        Entry_Nombre.pack()
        lbl_Cedula= Label(root, text='Cédula:',bg='purple',fg='yellow').pack()
        Cedula = IntVar()
        Entry_Cedula = Entry(root, textvariable=Cedula)
        Entry_Cedula.pack()
        Clase= IntVar()
        Ubicacion_ = IntVar()
        centro = Checkbutton(root, text='Centro',variable=Ubicacion_, onvalue=3,bg='purple',fg='yellow',selectcolor='black')
        def Ubicacion(x):
            centro.place(x=-5000,y=-5000)
            Label_ubicacion = Label(root, text='Ubicación:',bg='purple',fg='yellow').place(x=120,y=125)
            ventana = Checkbutton(root, text='Ventana',variable=Ubicacion_, onvalue=1,bg='purple',fg='yellow',selectcolor='black')
            ventana.place(x=70,y=145)
            pasillo = Checkbutton(root, text='Pasillo',variable=Ubicacion_, onvalue=2,bg='purple',fg='yellow',selectcolor='black')
        ...
        def Reservar():
            ...
            if Disponibilidad==True:
                ...
                root.withdraw()
                sillas()
        Label_Clase = Label(root, text='Clase:',bg='purple',fg='yellow').pack()
        Ejecutiva = Checkbutton(root, text='Ejecutiva', variable=Clase, onvalue=1, command= lambda: Ubicacion(0),bg='purple',fg='yellow',selectcolor='black')
        Ejecutiva.place(x=70,y=100)
        Economica = Checkbutton(root, text='Económica', variable=Clase, onvalue=2, command= lambda: Ubicacion(1),bg='purple',fg='yellow',selectcolor='black')
        Economica.place(x=150,y=100)
        Btn_Reservar = Button(root, text='Reservar pasaje', command=Reservar,bg='purple',fg='yellow',font=('Sina Nova',11)).place(x=85,y=175)
    btn_Registrar = Button(Botonera, text='Registrar pasajero', command=Registrar_Pasajero,width=24,bg='purple',fg='yellow').pack(side=LEFT)
    def Eliminar_Pasajero():
        root.deiconify()
        root.title('Eliminación de Reserva')
        lbl_Cedula= Label(root, text='Cédula:',bg='purple',fg='yellow',font=('Sina Nova',11)).pack()
        Cedula_ = IntVar()
        ...
        btn_Confirmar = Button(root, text='Confirmar',command=Confirmar,bg='purple',fg='yellow',font=('Sina Nova',11)).pack()
    btn_Eliminar = Button(Botonera, text='Eliminar pasajero', command = Eliminar_Pasajero, width=24,bg='purple',fg='yellow').pack(side=LEFT)
    def Buscar_Pasajero():
        root.deiconify()
        ...
        def Buscar():
                ...
                root.withdraw()
        btn_Buscar = Button(root, text='Confirmar',command=Buscar,bg='purple',fg='yellow',font=('Sina Nova',11)).pack()
    btn_Buscar = Button(Botonera, text='Buscar pasajero',width=24,command=Buscar_Pasajero,bg='purple',fg='yellow').pack(side=LEFT)
    ...
    btn_Porcentaje_Ocup = Button(Botonera, text='Porcentaje ocupacion',width=20,command=Porcentaje_Ocupacion,bg='purple',fg='yellow').pack(side=LEFT)
#GUI
plane = ImageTk.PhotoImage(Image.open(r'C:\Users\brian\OneDrive\Escritorio\Avión Ejercicio\avion.jpg'))
